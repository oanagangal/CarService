#include "Solutii_Caroserie.h"
       ...
       int Solutii_Caroserie::capota_noua = 420;
...
double Solutii_Caroserie::remediere_lovitura(int k)
{
    ...
    return k*pas + 0.3 * Solutii_Caroserie::manopera;
}

double Solutii_Caroserie::schimb_capota()
{
    float pas = Solutii_Caroserie::pret_vopsea + Solutii_Caroserie::pret_lac;
    return Solutii_Caroserie::capota_noua + pas + 0.5 * Solutii_Caroserie::manopera;
}

double Solutii_Caroserie::schimb_aripa()
{
    float pas = Solutii_Caroserie::pret_vopsea + Solutii_Caroserie::pret_lac;
    return Solutii_Caroserie::aripa_noua + pas + 0.5 * manopera;
}

double Solutii_Caroserie::schimb_fataspate()
{
    float pas = Solutii_Caroserie::pret_vopsea + Solutii_Caroserie::pret_lac;
    return Solutii_Caroserie::fata_spate + pas + 0.5 * Solutii_Caroserie::manopera;
}
